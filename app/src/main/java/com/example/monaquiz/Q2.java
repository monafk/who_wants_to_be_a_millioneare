...
public class Q2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Q2.this);
                alertDialogBuilder
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mButtonChoice1.isChecked() == true){
                                    if (mButtonChoice1.getText() == mAnswer) {
                                        ...
                                        Toast.makeText(Q2.this, "Correct Answer", Toast.LENGTH_SHORT).show();
                                        updateQuestion();
                                    } else {
                                        Toast.makeText(Q2.this, "Wrong!", Toast.LENGTH_SHORT).show();
                                        updateQuestion();
                                    }
        ...
        editor.putString("scYou Earned: $",newScore);
        editor.commit();
    ...
    private void updateQuestion () {
        if (mQuestionNumber < mQuestionLibrary.getLength()) {
            ...
            Toast.makeText(Q2.this, "Good Job! this is the last question :)", Toast.LENGTH_SHORT).show();
            ...
            editor.commit();
            Intent intent = new Intent(Q2.this,win.class);
            startActivity(intent);}
            else {
