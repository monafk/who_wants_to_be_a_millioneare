    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Q8.this);
                alertDialogBuilder
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mButtonChoice1.isChecked() == true){
                                    if (mButtonChoice1.getText() == mAnswer) {
                                        ...
                                        Toast.makeText(Q8.this, "Correct Answer", Toast.LENGTH_SHORT).show();
                                        updateQuestion();
                                    } else {
                                        Toast.makeText(Q8.this, "Wrong!", Toast.LENGTH_SHORT).show();
                                        updateQuestion();
                                    }
    ...
    private void updateQuestion () {
        if (mQuestionNumber < mQuestionLibrary.getLength()) {
            ...
            mQuestionNumber++;
                ...
                Toast.makeText(Q8.this, "Good Job! this is the last question :)", Toast.LENGTH_SHORT).show();
                ...
                editor.putString("You Earned: $",newScore);
                editor.commit();
                Intent intent = new Intent(Q8.this,win.class);
                startActivity(intent);}
            else {
